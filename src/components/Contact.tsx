        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-primary font-medium tracking-hero text-sm uppercase">Contact Us</span>
            </div>
            ...
            <div className="space-y-4 mb-10">
              ...
              >
                ...
                <div>
                  ...
                  <div className="font-display text-2xl font-bold text-primary">480.464.7800</div>
                </div>
              </motion.a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="font-semibold">Phoenix Metropolitan Area & All of Arizona</div>
                </div>
              </motion.div>
            </div>
            ...
            >
              {['Licensed', 'Certified', 'Insured', 'BBB Accredited'].map((badge) => (
                <div 
                  key={badge}
          ...
          >
            <form onSubmit={handleSubmit} className="glass-card p-8 rounded-2xl">
              <h3 className="font-display text-2xl font-bold mb-6">Get Your Free Quote</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-foreground/80">Appraisal Type</label>
                  <select
